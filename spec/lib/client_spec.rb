        ...
        context "with proper fields" do
          ...
          context "with attributes from a hash" do
            ...
            it "applies type coercions before serializing" do
              @client.create(MySobjects::Whizbang, "Date_Field" => Date.civil(2011, 1, 1), "DateTime_Field" => DateTime.civil(2011, 2, 1, 12), "Picklist_Multiselect_Field" => %w(a b), "Name" => nil)
      ...
      describe "#update" do
        context "with proper fields" do
          ...
          context "with attributes from a hash" do
            ...
            it "applies type coercions before serializing" do
              stub_request(:patch, "https://na1.salesforce.com/services/data/v23.0/sobjects/Whizbang/rid").to_return(:body => nil, :status => 204)
              @client.update("Whizbang", "rid", "Date_Field" => Date.civil(2011, 1, 1), "DateTime_Field" => DateTime.civil(2011, 2, 1, 12), "Picklist_Multiselect_Field" => %w(a b), "Name" => nil)
